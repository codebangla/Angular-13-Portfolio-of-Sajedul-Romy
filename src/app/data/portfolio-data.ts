...
export const PORTFOLIOS: PortfolioData[] = [
    ...
    {id: "portfolioModal3", name: 'RomiRx', technology_used: 'Windows Form, C#, .NET 4.5', description: ' RomiRx is a prescription Writing and Printing Windows Desktop application for the Doctors in Bangladesh. The full demo of the application can be found at the Youtube Video link below.', img_url: 'assets/img/portfolio/romirx.png', project_url: 'https://www.youtube.com/watch?v=5qYO_60J3UI', github_url: 'N/A'},

    {id: "portfolioModal4", name: '1000+ Love Quotes', technology_used: 'C#, XAML', description: ' It is a Windows Store App for Windows Phone 8. 1000+ beautiful love quotes by poets, authors, novelists, scholars and famous persons. Share these love quotes via SMS, email, facebook and other social medi Listen these love quotes in your installed phone voice.', img_url: 'assets/img/portfolio/love-quotes.jpg', project_url: 'https://www.microsoft.com/en-sa/p/1000-love-quotes/9nblggh0k0qn', github_url: 'N/A'},

    {id: "portfolioModal5", name: 'Learn Accounting', technology_used: 'Apache Cordova, JS', description: 'Accounting Basic learning app developed in Apache Cordova for Windows Phone 8 and Windows 8 devices.', img_url: 'assets/img/portfolio/learn-accounting.jpg', project_url: 'https://www.microsoft.com/en-us/p/learn-accounting/9NBLGGH1NVNZ', github_url: 'https://github.com/codebangla/Accounting-Learning-App'},


    {id: "portfolioModal6", name: 'React Redux Article', technology_used: 'React, React-redux', description: 'It is a simple article demo app to show redux or flux architecture implementation', img_url: 'assets/img/portfolio/react-redux-article-demo.png', project_url: 'N/A', github_url: 'https://github.com/codebangla/react-redux-article'},
